...
class ShapeNetCorePartDataset(CacheDataset):
    ...
    [ProjectPage]_ also releases a processed version of ShapeNet-Part
    containing point cloud and normals with expert-verified
    segmentations, which we use here.
    ...
    References:
        ...
        .. [Yi2016] `"A scalable active framework for region annotation
           ...
           by Li Yi, Vladimir G. Kim, Duygu Ceylan, I-Chao Shen, Mengyan
           Yan, Hao Su, Cewu Lu, Qixing Huang, Alla Sheffer, and
           Leonidas Guibas, ACM Transactions on Graphics, 2016.
        ...
        .. [PapersWithCode] `ShapeNet-Part Benchmark (3D Part Segmentation)
